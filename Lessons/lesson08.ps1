...
Get-ChildItem "path to dir" | Select-Object Name, CreationTime, LastWriteTime | Sort-Object -LastWriteTime | Export-Csv -Path "output.csv" -NoTypeInformation $data | ConvertTo-Html | Out-File "output.html"
